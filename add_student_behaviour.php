...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> <a href="manage_student_behaviour.php?"><button type="button" class="btn btn-dark btn-rounded btn-icon"><i class="mdi mdi-keyboard-backspace"></i></button></a></h4>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form_submit" class="form-sample" action="student_behaviour_post.php?" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="token" id="token" value="Hk4A3ehHsjhoaT6BlJ4E7MnYx8GQOXd2">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 dis_month"> 
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select name="activties" id="activties" class="form-control minput">
                                                    <option value="">--Select activties type--</option>
                                    ...
                                    <div class="col-md-12 dis_month"> 
                                        <textarea class="form-control" id="exampleTextarea1" name="des" placeholder="Message.." rows="2"></textarea>
                                    </div>
                                    <div class="col-md-12 dis_month">
                                        <br>
...
$("#find_student").click(function(){
       ...
       // alert(43535);
        ...
        $('form').submit(function(e){
            ...
            var date = $('#date').val();
            var des = $('textarea#exampleTextarea1').val();
            var unit = $('#unit').val();
            var scl_session = $('#scl_session').val();
