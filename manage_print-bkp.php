        ...
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                    <div >
            <!-- Table -->
             <form name="frmsearch" method="post" action="moneybook.php" id="frmsearch" >
            <table id='empTable' class='display dataTable'>
                <thead>
                 <tr>
                        <td class="text" align="center" colspan="8" valign="top">
                        <!--<select name="scl_session" class="form-control" style="width: 188px;margin-left: 146px;">-->
                        ...
                        <!--</select>-->
						<input type='date' class='form-control' name='fromDate' style="width: 152px;margin-top:4px;margin-left: -582px;" value='' id="fromDate">
                        <input type='date' class='form-control' name='endDate' style="width: 152px;margin-top: -47px;margin-left: -250px;" value='' id="endDate">
                        <button type="submit" value="" class="btn btn-primary button" valign="center" style="margin-left: 634px;"> Money Registration Book</button>
