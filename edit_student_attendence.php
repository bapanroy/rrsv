...
{
$id=$_GET['id'];
$sql="select * from   rrsv_student_attendence where id=$id";
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <select name="student_id" id="student_id" class="form-control minput">
                                                    ...
                                                    ?>
                                                    <option value="<?=$rows['id'];?>" <?php echo ((int)$student_id == (int)$rows['id']) ? "selected" : "" ?>><?=$rows['scl_name'];?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                </select>
