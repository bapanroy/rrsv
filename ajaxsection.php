...
while ($row = mysqli_fetch_assoc($empRecords)) {
    ...
    $data[] = array(
        "sl_no"=>$c,
    		...
    		"action"=>'<a href="add_section.php?id='.$row['id'].'"><i class="btn btn-primary btn-sm">Edit</i></a> <a href="manage_section.php?dId='.$row['id'].'"><i class="btn btn-danger btn-sm">Delete</i></a>'
    	);
}
