...
<td><tr>
       ...
       <tr height="30" style="background:#0a5079;border-color: #d29c29;">
                ...
                <tr>
                 <td><select name="marksheet[subject][]" class="cat" id="sub_id1" accesskey="1">
								<option value="">-Select Subject -</option>
                      <?php echo fill_sub($myDB);?>
							    	</select></td>
                      
                        <td><input type="text"  class="writencal" id="writen1" name="marksheet[unit_marks][]" placeholder="Marks" accesskey="1" /></td>
				    	<td  ><input type="text"  class="oralcal" id="oral1" name="marksheet[unit_hm][]" placeholder="H.M" accesskey="1"  /></td>
				        <td>&nbsp;</td>
                         </tr>
   	                    </table></td></tr>
