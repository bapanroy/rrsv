...
">
                <tr>
                  ...
                  <td style="width:10%">Comission Prectantage</td>
                  <td style="width:10%">Comission Amount</td>
                  <td style="width:10%">Purchase Value</td>
                  ...
                  <td style="width:10%">Total Sale Price</td>
                  ...
                  <td style="width:10%; text-align:center;">Actions</td>
                </tr>
                <?php
                $c = 0;
                ...
                while ($rows = mysqli_fetch_array($res)) {
                  ...
                  <tr>
                    ...
                    <td class="text" style="padding-left:10px;" valign="center"><?= $rows['mrp']; ?></td>

                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['total']; ?></td>
                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['comission_prectantage']; ?>
                    </td>
                    <td class="text" style="padding-left:10px;" valign="center"><?= $rows['comission_amount']; ?></td>
                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['purchase_value']; ?></td>

                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['purchase_value_per_unit']; ?>
                    </td>
                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['sale']; ?>
                    </td>
                    <td class="text" style="padding-left:10px;" valign="center"><?= $rows['stock_after_sale']; ?></td>
                    <td class="text" valign="center" style="padding-left:10px;"><?= $rows['price']; ?></td>
                ...
                <tr style="font-weight: bold;">
                  ...
                  <td><?= $totals['qty']; ?></td>
                  <td><?= number_format($totals['mrp'], 2); ?></td>
                  <td><?= number_format($totals['total'], 2); ?></td>
                  <td><?= number_format($totals['commission_percentage'], 2); ?></td>
                  <td><?= number_format($totals['commission_amount'], 2); ?></td>
                  <td><?= number_format($totals['purchase_value'], 2); ?></td>
