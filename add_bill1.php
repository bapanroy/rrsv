...
<form name="hh" action="add_student_fee_post.php" method="post">
  ...
  $sql="select a.*,b.scl_name,b.scl_roll_no from rrsv_scl_studen_fee as a,rrsv_student_registration as b where a.pay_id=b.id and b.id=$id";
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                     ...
                                     ?>
                                     <tr>
                                           <td>Total Book Cost:<?php echo $cost;?></td>
                                     </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-sample" action="add_bill_post.php" method="post">
                            ...
                            <div class="row">
                                    ...
                                    if($addstatus=='New Admission'){
                                    ?>
                                    <div class="col-md-6 dis_admission new_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="admission_fee" onchange="myFunction()" style="margin-right: 10px;"></span>New Admission Fee:</label>
                                            <div class="col-sm-6">
                                    ...
                                    <?php } else { ?>
                                    <div class="col-md-6 dis_admission re_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="re_admission_fee" onchange="myFunction()" style="margin-right: 10px;"></span>Re Admission Fee:</label>
                                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4 dis_month"> 
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="monthly_fee" onchange="myFunction()" style="margin-right: 10px;"></span>Monthly Fee:</label>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="admission" onchange="myFunction()" style="margin-right: 10px;"></span>Admission Form:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="admission_val" name="admission_val"  onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="uniform" onchange="myFunction()" style="margin-right: 10px;"></span>Student Uniform:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="uniform_val" name="uniform_val" onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="icard" onchange="myFunction()" style="margin-right: 10px;"></span> Icard:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="icard_val" name="icard_val"  onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="sweater_slax_cap" onchange="myFunction()" style="margin-right: 10px;"></span>Sweater,Slax,Cap:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="sweater_slax_cap_val" name="sweater_slax_cap_val"  onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="bag" onchange="myFunction()" style="margin-right: 10px;"></span>Bag:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="bag_val" name="bag_val" onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 dis_admission">
                                        <div class="form-group row">
                                            <label class="col-sm-6 col-form-label"><span><input type="checkbox" class="cost_data" data-id="shoes_sockes" onchange="myFunction()"  style="margin-right: 10px;"></span>Shoes & Sockes:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="shoes_sockes_val" name="shoes_sockes_val" onchange="myFunction()" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 dis_month">
       ...
       echo    $actual_cost=$total_other_cost+$book_cost;
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $('#testSelect1').filter(function(){ return $(this).children("option").length > 1 }).length) {
...
// if ( $('#menu ul').filter(function(){ return $(this).children("li").length > 1 }).length) {
        ...
        $(".book_name").click(function(){
            ...
            if(payment_val != 0) {
                alert("Please Remove the Amount of the Payment Received then the User can change any input field.");
                return false;
            }
            var id = $(this).data("id");
        ...
        $(".open_form").click(function(){
            ...
            if (id == "new_admission") {
                ...
                if($('#re_admission').is(':checked') || $('#monthly').is(':checked')) {
                    alert('you can check one check box at a time.');
                    return false;
                }
            
                if ($(this).is(':checked')) {
                    $(".re_admission").css("display","none");
                } else {
                    $(".re_admission").css("display","block");
                }
            }
            if (id == "re_admission") {
                
                if($('#new_admission').is(':checked') || $('#monthly').is(':checked')) {
                    alert('you can check one check box at a time.');
                    return false;
                }
                
                if ($(this).is(':checked')) {
                    $(".new_admission").css("display","none");
                } else {
                    $(".new_admission").css("display","block");
                }
            }
            if (id == "monthly") {
                
                if($('#new_admission').is(':checked') || $('#re_admission').is(':checked')) {
                    alert('you can check one check box at a time.');
                    return false;
                }
