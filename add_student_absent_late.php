...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> <a href="manage_student_absent_late.php?"><button type="button" class="btn btn-dark btn-rounded btn-icon"><i class="mdi mdi-keyboard-backspace"></i></button></a>Add Student Absent/Late</h4>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form_submit" class="form-sample" action="student_absent_late_post.php?" method="GET" enctype="multipart/form-data">
                            <input type="hidden" name="token" id="token" value="Hk4A3ehHsjhoaT6BlJ4E7MnYx8GQOXd2">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 dis_month"> 
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select name="status" id="status" class="form-control minput">
