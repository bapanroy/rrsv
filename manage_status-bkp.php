        ...
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                    <div >
            <!-- Table -->
             <form name="frmsearch" method="post" action="registration.php" id="frmsearch" >
            <table id='empTable' class='display dataTable'>
                <thead>
                 <tr>
                        <td class="text" align="center" colspan="8" valign="top">
                        <select name="status" class="form-control" style="width: 188px;margin-left: 290px;">
						...
						<input type='date' class='form-control' name='fromDate' style="width: 152px;margin-top: -47px;margin-left: -870px;" value='' id="fromDate">
                        <input type='date' class='form-control' name='endDate' style="width: 152px;margin-top: -47px;margin-left: -538px;" value='' id="endDate">
                        <button type="submit" value="" class="btn btn-primary button" valign="center" style="margin-left: 634px;"> Status Report</button>
