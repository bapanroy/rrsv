                 ...
                 <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Tuition Fees for whole year  :</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Sateelment Amount :</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="satamount" name="amount1" value=''  disabled="">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Total Cost Information for Whole Year</h4>
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Monthly Fees for whole year  :</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="monthly_whole_year_Cost" name="total_monthly_fee" value='Loading....' readonly>
                                </div>
                            </div>
                               <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Sateelment Amount :</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="satamount1" name="amount1" value='<?php echo $amount1;?>'  disabled="">
                                      <input type="checkbox" id="isNews1" name="isNews">
                                </div>
                            </div>
...
var  amount1=('<?php echo $amount1;?>');
if(amount1!=0){
     
     $("#satamount").val(amount1);
    
}
else {
    
       $("#satamount").val(Number($("#total_cost1").val())+Number($("#monthly_whole_year_Cost").val()));
}  
  ...
  if(amount1!=0){
     ...
     $("#satamount1").val(amount1);
    
} 
else{
   
    $("#satamount1").val(Number($("#total_cost2").val())+Number($("#monthly_whole_year_Cost").val()));
}
     });
