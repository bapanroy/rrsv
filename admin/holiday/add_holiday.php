          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action='' method='' name="holiday">
              ...
              <div class="form-group">
                <label for="exampleInputUsername1">Holiday Name<span class="text-red"> * </span></label>
                <input type="text" class="form-control" id="name" placeholder="Holiday  Name" name="name"
                  value='<?= $rows['name']; ?>' required>
                <span id="error" style="color:red;"></span>
              </div>
              <div class="form-group">
                <label for="exampleInputUsername1">Date of Holiday<span class="text-red"> * </span></label>
                <input type="date" class="form-control" id="d_o_h" placeholder="Holiday  Date of Holoday" name="d_o_h"
                  value='<?= $rows['d_o_h']; ?>' required>
