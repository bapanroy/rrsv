...
{
$id=$_GET['id'];
$sql="select * from  rrsv_admission where id=$id";
...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> <a href='manage_admission.php'><button type="button" class="btn btn-dark btn-rounded btn-icon"><i class="mdi mdi-keyboard-backspace"></i></button></a></h4>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form_submit" class="form-sample" action="#" method="POST" enctype="multipart/form-data">
