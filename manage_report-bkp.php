            ...
            <table id='empTable' class='display dataTable'>
                <thead>
                        ...
                        <td class="text" align="center" colspan="8" valign="top">
							<select name="scl_session" class="seinput" value="<?=$rows['scl_session'];?>" id="scl_session">
                            ...
                            <select name="scl_class" class="cinput" id="scl_class">
                            ...
                            <!--</select>-->
                            <input type="text" name="txtsearch" class="tinput" value="" size="30" maxlength="100"  placeholder="Search By Name,Roll No">
                             <button type="submit" value="" class="btn btn-primary button" valign="center"><i class="fa fa-search"></i></button>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
        <?php
                               ...
                               {
                              ?>
      <a class="page-link" href="manage_bill.php?page=<?=($page-1);?>" tabindex="-1">Previous</a>
    </li>
    <?php
                              }
                              ?>
