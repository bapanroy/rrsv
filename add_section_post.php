...
include('include/dbcon.php');
	...
	$section_name 		=$myDB->escape_string(trim(addslashes($_POST['section_name'])));
...
if($id > 0) {
	...
	where id							='".$id."'";
		...
		$strsql="select * from rrsv_section where class_name ='".$class_name."' and section_name='".$section_name."'";
...
// 			exit();
		...
		$sqlIn="insert into rrsv_section 
						set
				class_name	='".$class_name."',
				section_name	='".$section_name."'";
