...
<a href="https://wa.me/<?php echo $alt_phone;?>?text=Hi, Welcome to RASULPUR RAMKRISHNA SARADA VIDYAPITH.
 Dear student your registration is successful.
 Your registration number is: <?=$rows['scl_reg_no'];?>" target="_blank" class="btn btn-success"><i class="mdi mdi-whatsapp"></i></a>
                    </td>
