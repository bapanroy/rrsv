...
<!--</table>-->
 <table border=1 style="width: 120%; height: 115%;">
            ...
            <tr>
                <td>
                   ...
                   $sql="select a.*,b.* from marksheet as  a , marksheet_details as b  where b.scl_semi='1st Semister' and b.reg_id='".$rows['id']."' and a.scl_class='$scl_class'and  a.id=b.m_id";         
                ...
                <td>
                  ...
                  $sql="select a.*,b.* from marksheet as  a , marksheet_details as b  where b.scl_semi='2nd Semister' and b.reg_id='".$id."' and a.scl_class='$scl_class'and  a.id=b.m_id";         
                $res=mysqli_query($myDB,$sql);
                $res=mysqli_query($myDB,$sql);
                 while($rows=mysqli_fetch_array($res))
                {
  ...
  <td  style="color:blue;text-align:left;" class="pd1">Grand</td>
         ...
         //  echo   $sql="select a.book_name,b.sub_id,b.ful,b.writen,b.oral,b.total,b.grade,b.scl_semi from rrsv_book as a , marksheet_details as b ,marksheet as c where b.scl_semi='3rd Semister' and b.reg_id='".$id."' and a.scl_class='$scl_class'and  c.id=b.m_id group by b.sub_id ";         
             $sql="select a.*,b.* from marksheet as  a , marksheet_details as b  where b.scl_semi='3rd Semister' and b.reg_id='".$id."' and a.scl_class='$scl_class'and  a.id=b.m_id";         
                $res=mysqli_query($myDB,$sql);
                $res=mysqli_query($myDB,$sql);
                 while($rows=mysqli_fetch_array($res))
                {
 ...
 <td >
          ...
          <?php
                                   ...
                                   $sql="select a.*,b.* from marksheet as  a , marksheet_details as b  where b.scl_semi='1st Semister'  and b.reg_id='".$id."' and a.scl_class='$scl_class'and  a.id=b.m_id";         
                                    $res=mysqli_query($myDB,$sql);
