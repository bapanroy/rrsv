...
<div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                    <div >
            <!-- Table -->
             <form name="frmsearch" method="post" action="register.php" id="frmsearch" >
            <table id='empTable' class='display dataTable'>
                <thead>
                 <tr>
						...
						<input type='date' class='form-control' name='fromDate' style="width: 206px;margin-top: -4px;margin-left: -379px;" value='' id="fromDate">
                        <input type='date' class='form-control' name='endDate' style="width: 206px;margin-top: -47px;margin-left: 54px;" value='' id="endDate">
                        <button type="submit" value="" class="btn btn-primary button" valign="center" style="margin-left: 429;"> Register Report</button>
 ...
 $bgcolor="";
                       ...
                       //$sql="select a.*,b.class_name from rrsv_student_registration as a,class as b where a.scl_class=b.id ";
                         ...
                         if($txtsearch!="")
                         {
                        $sql.=" and (scl_name LIKE '%$txtsearch%' || scl_roll_no LIKE '%$txtsearch%' )";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
        <?php
                               ...
                               {
                              ?>
      <li class="page-item"> <a class="page-link" href="manage_register.php?page=<?=($page-1);?>" tabindex="-1">Previous</a>
    </li>
    <?php
                              }
                              ?>
                              ...
                              {
                              ?>
    <li class="page-item"><a class="page-link" href="manage_register.php?page=<?=$i;?>"><?php echo $i ?></a></li>
                              <?php
                              }
                              ?>
                              ...
                              ?>
    <li class="page-item">
      <a class="page-link" href="manage_register.php?page=<?=($page+1);?>">Next</a>
    </li>
      <?php
                              }
