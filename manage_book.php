...
<div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> <a href='add_book.php'><button type="button" class="btn btn-primary btn-rounded btn-fw"><i class="mdi mdi-comment-plus-outline"></i> Add Book Rate</button></a></h4>
                   </div>
            </div>
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                    <div >
            <!-- Table -->
             <form name="frmsearch" method="post" action="manage_book.php" >
...
">
 ...
 <?php
                         ...
                         $sql="select * from rrsv_book where 1";
		                  if($scl_session!="")
                         {
					    ...
					    <td  class="text" valign="top"><?=$rows['book_name'];?></td>
						<td  class="text" valign="top"><?=$rows['book_pub'];?></td>
						<td  class="text" valign="top">	
						<?=$rows['rate'];?><br>
					
						</td>
                        <td  class="text" valign="top">
                         <a href="add_book.php?id=<?=$rows['id'];?>" title="Click to edit this course" class="btn btn-primary btn-sm"><b>Edit</b></a>
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
        <?php
                               ...
                               {
                              ?>
      <li class="page-item"><a class="page-link" href="manage_book.php?page=<?=($page-1);?>" tabindex="-1">Previous</a>
    </li>
    <?php
                              }
                              ?>
                              ...
                              {
                              ?>
    <li class="page-item"><a class="page-link" href="manage_book.php?page=<?=$i;?>"><?php echo $i ?></a></li>
                              <?php
                              }
                              ?>
                              ...
                              ?>
    <li class="page-item">
      <a class="page-link" href="manage_book.php?page=<?=($page+1);?>">Next</a>
    </li>
      <?php
                              }
