                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="container pt-50 pb-50">
                                                                    ...
                                                                    <div id="resultTable" class="mt-4"></div>
                                                                     <button type="hidden" id="downloadPdfBtn" class="btn w-100"></button>
                                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-7 pl-50">
                    <h2 class="title line-bottom mb-20 mt-0">Why <span class="text-theme-color-red">Choose
                            Us</span> ?</h2>
                    রসুলপুর রামকৃষ্ণ সারদা বিদ্যাপীঠ একটি ইংরেজি মাধ্যম বিদ্যালয় , যা ২০১২ সালে প্রতিষ্ঠিত হয়। বর্তমানে বিদ্যালয়টি পশ্চিমবঙ্গ সরকারের শিক্ষা দপ্তরের অধীন বাংলা শিক্ষা পোর্টালের অন্তর্ভুক্ত। বিদ্যালয় টি গ্রামীণ পরিবেশে অবস্থিত হলেও এর যোগাযোগ ব্যবস্থা অত্যন্ত ভালো, ফলে আশেপাশের বহু ছাত্র ছাত্রী এখানে পড়াশুনা করে। বিদ্যালয়ের মূল লক্ষ্য হলো শিশুদের জ্ঞান, শৃঙ্খলা ও মানবিক মূল্যবোধ গড়ে তোলা। সম্পূর্ণ ইংরেজি মাধ্যম এই বিদ্যালয়ে মাতৃভাষা বাংলা ও সর্বভারতীয় ভাষা হিসাবে হিন্দি কে সমান গুরুত্ব সহকারে পড়ানো হয়। এখানে প্রশিক্ষিত শিক্ষক শিক্ষিকারা স্নেহ ও যত্নের সঙ্গে পাঠদান করেন।শিশুদের যত্ন নেওয়ার জন্য আছেন স্নেহশীল আন্টিরা, যারা শিশুদের দেখাশোনা করেন যেন তারা ঘরের মতো স্বাচ্ছন্দ্য অনুভব করে। বিদ্যালয়ে আছে শিশুদের জন্য পরিকল্পিত ও সুচিন্তিত পাঠ্যক্রম যা প্রতি শ্রেনীর সঙ্গে পারস্পরিক সম্পর্ক যুক্ত। শুধু পড়াশোনাই নয় , সঙ্গে রয়েছে আঁকা, কম্পিউটার এর মত সহ শিক্ষা কার্যক্রম। এই সব কার্যক্রম ছাত্র ছাত্রী দের মননশীলতা, আত্মবিশ্বাস ও উৎসাহ বাড়ায়।প্রতি বছর বিভিন্ন শিক্ষামূলক প্রতিযোগিতায় অংশগ্রহণ করে ও সাফল্য অর্জন করে ছাত্র ছাত্রী রা বিদ্যালয়ের সুনাম উজ্জ্বল করছে। সবুজে ঘেরা পরিবেশ, পরিষ্কার পরিচ্ছন্ন ক্লাসরুম আর শিক্ষামূলক আবহ এই বিদ্যালয় কে এক শিশু দের উপযোগী সঠিক বিদ্যালয় হিসাবে গড়ে তুলেছে। বিদ্যালয়ের মূলমন্ত্র " শিক্ষাই অন্ধকার দূর করার একমাত্র আলো" ভবিষ্যতে বিদ্যালয় টিকে আরো উচ্চতর শ্রেনী পর্যন্ত সম্প্রসারিত করার পরিকল্পনা রয়েছে,এবং উন্নত প্রযুক্তির ব্যবহার করে স্মার্ট ক্লাস ও ডিজিটাল এডুকেশন কে শিক্ষার মাধ্যম হিসাবে ব্যবহার করার কাজ বিদ্যালয়ের দায়িত্বশীল পরিচালন কর্তৃপক্ষ অনেক খানি এগিয়ে নিয়ে গেছেন।যাতে গ্রামীণ এলাকার আরও বেশি শিশু সঠিক মানসম্পন্ন শিক্ষার সুযোগ পায়। এটি সেই বিদ্যালয় যেখানে শিক্ষা, মননশীলতা ও স্নেহ একসঙ্গে বিকশিত হয়।।
                    <!-- <p class="mb-50">
...
<script>
    ...
    $(document).ready(function () {
       ...
       // Collect required fields
        ...
        $('#admission_form .error-text').remove();

        let isValid = true;

        const requiredFields = [
            'scl_date', 'scl_class', 'scl_session', 'scl_section',
            'scl_name', 'scl_aadhar', 'scl_phone_no', 'alt_phone',
            'scl_father_name', 'scl_mother_name', 'scl_gender',
            'scl_dob', 'scl_religion', 'scl_language', 'religion',
            'nationality', 'scl_disa', 'scl_email', 'scl_ide',
        ...
        requiredFields.forEach(field => {
            ...
            if (!value) {
                ...
                // Find label text
                let labelText = $input.closest('.mb-3').find('label').text().replace('*', '').trim();

                // Add inline error message
                $input.closest('.mb-3').append(`<small class="error-text text-danger">Please fill out ${labelText}.</small>`);
        ...
        // Show Swal summary if any missing
        if (!isValid) {
            Swal.fire({
                icon: 'warning',
                title: 'Missing Required Fields',
                html: `<b>Please fill the following:</b><br>${missingLabels.join(', ')}`,
                confirmButtonColor: '#d33'
            });
            return false;
        }
