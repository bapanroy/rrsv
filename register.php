...
<html >
  ...
  <body>
  <button type="button" id="backPageButton" class="btn btn-info"><a style="color: #fff" href="manage_register.php">Back</a></button>
    ...
    <section id="main-content">
     ...
     <input type='hidden' class='srinputd' name='endDate' value='<?php if(isset($_POST['endDate'])) echo $_POST['endDate']; ?>'>
		...
		<!--</div>-->
		<h5 style="margin-left: 74px;">	Start Date &nbsp;:&nbsp;<?php if($fromDate==''){
...
Status:<?php echo $add_status;?><br>Total:<p id="totalstatus1"></p> 
</h5>
     <table border="1">
  <tr> 
