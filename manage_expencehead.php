...
if($retcode==1) {
  $msg="Expence Head has been editted successfully";
}

if($retcode==2) {
  $msg="Expence Head has been add successfully";
}

if($retcode==3) {
  $msg="Expence Head has been deleted successfully";
}
if(isset($_GET['dId']) && !empty($_GET['dId'])) {
    
    $sql="Delete from rrsv_expence_head where id='".(int)$_GET['dId']."'";
    $res=mysqli_query($myDB,$sql);
    if($res) { ?>
       
        <script>;
            alert('Expence Head Delete successfully!');
            window.location.replace('http://rrsv.in/manage_expencehead.php?');
        </script>;
    <?php  } ?>
...
<div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> <a href='add_expencehead.php'><button type="button" class="btn btn-primary btn-rounded btn-fw"><i class="mdi mdi-comment-plus-outline"></i> Add Expense Head</button></a></h4>
